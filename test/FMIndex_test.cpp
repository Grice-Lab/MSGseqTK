...
int main() {
	...
	if(count1 != 1)
		return 1;
	cout << "All mapped loc:";
	for(const Loc& loc : rfm1.locateAll(pat))
		cout << " " << loc;
	cout << endl;
	if(!isValidLocs(seqM1, pat, rfm1.locateAll(pat)))
		return 1;
	...
	if(count2 != 2)
		return 1;
	cout << "All mapped loc:";
	for(const Loc& loc : rfm2.locateAll(pat))
		cout << " " << loc;
	cout << endl;
	if(!isValidLocs(seqM2, pat, rfm2.locateAll(pat)))
		return 1;
	...
	if(count != count1 + count2)
		return 1;
	cout << "All mapped loc:";
	for(const Loc& loc : rfm.locateAll(pat))
		cout << " " << loc;
	cout << endl;
	if(!isValidLocs(seqM, pat, rfm.locateAll(pat)))
		return 1;
}
