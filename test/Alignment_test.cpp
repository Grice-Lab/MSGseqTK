...
int main(int argc, char* argv[]) {
	...
	/* build an alignment */
	Alignment aln1(&r1, &rc1, &target1, 0, GLoc::FWD, 0,
	...
	/* build an alignment */
	Alignment aln2(&r2, &rc2, &target2, 0, GLoc::FWD, 0,
	...
	/* build an alignment */
	Alignment aln3(&r3, &rc3, &target3, 0, GLoc::FWD, 0,
	...
	/* build an alignment */
	Alignment aln4(&r4, &rc4, &target4, 0, GLoc::FWD, 0,
	...
	/* build an alignment */
	Alignment aln5(&r5, &rc5, &target5, 0, GLoc::FWD, 0,
