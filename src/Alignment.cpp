...
bool Alignment::SeedMatch::isCompatitable(int64_t maxIndel) const {
	if(size() <= 1) // less than 1 SeedPair
		return true;
...
int32_t Alignment::SeedMatch::length() const {
	int32_t len = 0;
...
Alignment::SeedMatch& Alignment::SeedMatch::filter(int64_t maxIndel) {
